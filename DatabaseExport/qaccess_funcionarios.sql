...
CREATE TABLE `funcionarios` (
  `idfuncionario` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `cargo` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_general_ci DEFAULT NULL,
