...
CREATE TABLE `condominos` (
  `idcondomino` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `nome` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cpf` double DEFAULT NULL,
  `dataNascimento` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `contato` double DEFAULT NULL,
  `estadoCivil` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `idunidade` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2022-06-19  3:49:13
