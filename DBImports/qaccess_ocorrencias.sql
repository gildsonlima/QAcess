...
CREATE TABLE `ocorrencias` (
  `idOcorrencia` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `local` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `descricao` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `idCondomino` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
